...
MODELS = ("YOLO", "SSTN", "SALWANet", "YOLOWorld", "YOLOE", "NAS", "SAM", "FastSAM", "RTDETR")
...
if TYPE_CHECKING:
    ...
    from ultralytics.models import YOLO, SSTN, SALWANet, YOLOWorld, YOLOE, NAS, SAM, FastSAM, RTDETR  # noqa
